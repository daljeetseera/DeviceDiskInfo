...
open class DiskInformation: NSObject {
    ...
    @objc func getTotalFreeSpace() -> String{ //Get total free space
        do{
    ...
    @objc func getTotalUsedSpace() -> String{ //Get total disk usage from above variable
